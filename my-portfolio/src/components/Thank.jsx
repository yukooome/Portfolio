...
function Thank() {
  return (
    <section id="about" className="about-section">
      ...
      <p>
    Je souhaite exprimer toute ma gratitude à l'équipe de <strong><a href="https://interface3.be/fr" target="_blank">Interface3</a></strong> ainsi qu'à tous les formateurs qui m'ont guidée tout au long de cette expérience incroyable. Grâce à eux, j'ai non seulement découvert l'univers du développement web, mais j'ai aussi appris à m'adapter, à utiliser la documentation technique et à devenir autonome dans la résolution des problèmes.
</p>
